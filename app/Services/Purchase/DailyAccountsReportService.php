...
class DailyAccountsReportService
{
    ...
    public function buildNotificationMessage(string $employeeName, array $report): string
    {
        ...
        return sprintf(
            'Hesabu ya %s ya tarehe %s imeingizwa tayari. Baki ya tarehe %s ni %s. Mauzo/Mapato ya tarehe %s ni %s. Jumla ya baki na mauzo/mapato ni %s. Jumla ya matumizi na manunuzi ni %s. Baki mpya ni %s. Ingia kwenye mfumo kuangalia bonyeza mboje.sys.co.tz',
            $employeeName,
