...
Route::prefix('purchases')->name('purchases.')->middleware(['auth', 'company.scope', 'check.inventory.cost.method', 'require.branch'])->group(function () {
    ...
    Route::prefix('daily-accounts')->name('daily-accounts.')->group(function () {
        ...
        Route::get('/employees', [\App\Http\Controllers\Purchase\DailyAccountsController::class, 'employeesIndex'])->name('employees.index');
    ...
    Route::prefix('supplier-advances')->name('supplier-advances.')->group(function () {
        ...
        Route::delete('/statement/{encodedSupplierId}/advance/{encodedAdvanceId}', [\App\Http\Controllers\Purchase\SupplierAdvanceController::class, 'destroyStatementAdvance'])->name('statement.advance.destroy');
